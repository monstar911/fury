...
func init() {
	proto.RegisterType((*Reserver)(nil), "furynetwork.fury.strategicreserve.Reserver")
}

func init() {
	proto.RegisterFile("fury/strategicreserve/reserver.proto", fileDescriptor_a346a0fea33afb26)
}
